...
#define GUAC_RDP_CLIPBOARD_MAX_FILES 16
#define GUAC_RDP_CLIPBOARD_MAX_FILE_SIZE (256ULL * 1024ULL * 1024ULL)
#define GUAC_RDP_CLIPBOARD_MAX_FILENAME 512
...
typedef struct guac_rdp_clipboard {
    ...
    int file_active;
    int file_waiting_for_size;
    int file_size_known;
    int file_download_active;
    int file_fd;
    UINT32 file_stream_id;
    UINT32 file_list_index;
    UINT32 file_requested_bytes;
    uint64_t file_size;
    uint64_t file_received;
    char file_path[PATH_MAX];
    char file_name[GUAC_RDP_CLIPBOARD_MAX_FILENAME];
